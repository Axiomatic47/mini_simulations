...
def create_cross_level_visualizations(validator, output_dir='validation/reports/cross_level'):
    ...
    dependency_graph = validator.get_dependency_graph()
    ...
    propagation_results = validator.run_signal_propagation_test() if hasattr(validator, 'run_signal_propagation_test') else None
